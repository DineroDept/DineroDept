...
function popup13() {
  CreativaPopup.create(
    'Feel Free To Contact Us <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">623-300-4507</font> &#10084<br> <font style="color: #696969; font-size: smaller;"> or follow us on instagram <a href="https://www.instagram.com/dinero_dept/" style="color: #ADD8E6;">https://www.instagram.com/dinero_dept/</a> </font>',
    "Contact Us",
    "",
    {
      titleColor: "#6ffcff",
...
function allahm109kd1() {
  navigator.clipboard.writeText("623-300-4507");
  setTimeout(function () {
    alert("Number was copied to the clipboard");
  }, 50);
}
